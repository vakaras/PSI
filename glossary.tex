...
\newglossaryentry{agentas}{
  name=agentas,
  description={
    naudotojas, esantis sistemos atžvilgiu tam tikrame vaidmenyje
    },
  plural=agentai
  }

\newglossaryentry{scenarijus}{
  name=scenarijus,
  description={
    žingsnių, aprašančių agentų ir sistemos sąveiką, seka
    },
  plural=scenarijai
  }

\newglossaryentry{scenarijaus_sprogimas}{
  name={scenarijaus sprogimas},
  description={
    situacija, kai atsiranda per daug užduočių modeliavimo abstrakcijos
    lygmenų
    }
  }

\newglossaryentry{reikalavimu_nustatymas}{
  name={reikalavimų nustatymas},
  description={
    procesas, kuriuo nustatoma, kokias paslaugas privalo teikti sistema
    ir kokiu ribojimus ta sistema turi tenkinti teikdama tas paslaugas
    }
  }

\newglossaryentry{reikalavimu_formulavimas}{
  name={reikalavimų formulavimas},
  description={
    procesas, kuriuo operaciniai poreikiai yra pertvarkomi į tikslų ir
    išsamų aprašą, ką sistema darys ir kaip ji veiks
    }
  }

\newglossaryentry{reikalavimu_specifikacija}{
  name={reikalavimų specifikacija},
  description={
    dokumentas, aprašantis ką turi daryti sistema ir kokius kitus
    reikalavimus ji turi tenkinti
    }
  }

\newglossaryentry{funkcinis_reikalavimas}{
  name={funkcinis reikalavimas},
  description={
    reikalavimas, nusakantis, kokias paslaugas privalo teikti sistema,
    kokia turi būti jos reakcija į konkrečius stimulus ir kaip ji turi
    elgtis konkrečiose situacijose
    },
  plural={funkciniai reikalavimai}
  }

\newglossaryentry{nefunkcinis_reikalavimas}{
  name={nefunkcinis reikalavimas},
  description={
    ribojimas potencialiai galimų projektinių sprendimų aibei
    },
  plural={nefunkciniai reikalavimai}
  }
